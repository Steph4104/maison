...
$adresse = mysqli_real_escape_string($conn, $adresse);
   ...
   $sql = "UPDATE info_maison SET link = '$lien', prix = '$prix', chambre = '$chambre', bain = '$bain', autobus = '$autobus', adresse = '$adresse', year = '$year', habitable = '$habitable', taxe_m = '$taxe_m', taxe_s = '$taxe_s', inclusion = '$inclusion', exclusion = '$exclusion', pour = '$pour', contre = '$contre', autre = '$comment'  WHERE id = '$id'";
